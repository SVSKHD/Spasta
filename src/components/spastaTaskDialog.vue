...
const emit = defineEmits<{
  (e: 'close'): void;
  (e: 'save', task: Omit<Task, 'id' | 'userId' | 'createdAt' | 'updatedAt'>): void;
}>();
...
const totalHours = computed(() => {
  return (newTask.value.timeEntries || []).reduce((sum, entry) => sum + entry.hours, 0);
});
...
const addTimeEntry = () => {
  ...
  newTask.value.actualHours = (newTask.value.actualHours || 0) + newTimeEntry.value.hours;
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="md:col-span-2">
              ...
              <input v-model="newTask.title" type="text" class="input" required placeholder="Enter task title" />
            </div>
            
            <div class="md:col-span-2">
              <label class="block text-sm font-medium text-gray-700">Description</label>
              <textarea v-model="newTask.description" class="input h-20" placeholder="Describe the task..." />
            </div>
            ...
            <div class="md:col-span-2">
              <div class="flex items-center space-x-2">
                ...
                />
                <label class="text-sm font-medium text-gray-700">Recurring Task</label>
              </div>
          ...
          <div class="border-t pt-4">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
              ...
              <div class="text-sm">
                ...
                <span class="ml-2 font-medium">{{ newTask.estimatedHours || '-' }}</span>
              </div>
            </div>
