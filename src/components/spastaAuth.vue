    ...
    <div class="fixed inset-0 flex items-center justify-center p-4">
      <DialogPanel class="w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
        <div class="text-center mb-8">
          ...
          <p class="text-sm text-gray-500 mt-2">Your all-in-one productivity suite</p>
        </div>
        ...
        <div v-if="props.errorMessage" class="mb-4 p-3 bg-error-100 text-error-700 rounded-md flex items-center">
